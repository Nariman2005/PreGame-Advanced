...
<jsp:include page="../common/header.jsp">
    <jsp:param name="title" value="Tester Registration" />
</jsp:include>
        ...
        <div class="register-form-container">
            ...
            <form action="${pageContext.request.contextPath}/auth" method="post" class="register-form">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="rank">Tester Rank</label>
                        <select id="rank" name="rank" class="form-control" required>
                            <option value="Junior">Junior Tester</option>
                            <option value="Associate">Associate Tester</option>
                            <option value="Senior">Senior Tester</option>
                            <option value="Principal">Principal Tester</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="experience">Testing Experience</label>
                    <textarea id="experience" name="experience" class="form-control" rows="3" placeholder="Describe your previous testing experience (optional)"></textarea>
                </div>
